...
В Draw доступны несколько типов окончаний линий (стрелки, кружки, квадратики и другие). Нажмите на маленький треугольник справа от значка *Линии и стрелки* |ch7-lo-screen-015| в панели инструментов *Рисование*, чтобы открыть палитру, содержащую инструменты для рисования стрелок и линий. Также можно использовать пункт меню :menuselection:`Вид --> Панели инструментов --> Стрелки`, чтобы открыть панель *Стрелки* в виде плавающей панели.

.. |ch7-lo-screen-015| image:: _static/chapter7/ch7-lo-screen-015.png
        :scale: 70% 

После того, как линия была нарисована, можно изменить стиль стрелки, нажав на значок *Стиль стрелок* |ch7-lo-screen-016| в панели инструментов *Линия и заливка*, и, выбрав из выпадающего списка вид начала (слева в списке) и конца (справа в списке) линии.

.. |ch7-lo-screen-016| image:: _static/chapter7/ch7-lo-screen-016.png
        :scale: 70% 

.. _ch7-lo-screen-017:

.. figure:: _static/chapter7/ch7-lo-screen-017.png
       :scale: 60 %
       :align: center
...
Квадрат – это прямоугольник, у которого все стороны равны. Чтобы нарисовать квадрат, нажмите на значок *Прямоугольник* |ch7-lo-screen-018| и удерживайте нажатой клавишу ``Shift`` во время рисования.

.. |ch7-lo-screen-018| image:: _static/chapter7/ch7-lo-screen-018.png
        :scale: 70% 

.. note:: Если активна опция *При создании или перемещении объектов* в разделе *Применять привязку* в меню :menuselection:`Сервис --> Параметры --> LibreOffice Draw --> Сетка`, то нажатие клавиши ``Shift`` приведёт к обратному эффекту: при выборе инструмента *Прямоугольник* будет рисоваться квадрат. А чтобы нарисовать прямоугольник, нужно будет зажать клавишу ``Shift``. Такая смена поведения клавиши ``Shift`` также применяется при рисовании эллипсов и окружностей. 
...
Чтобы нарисовать эллипс, нажмите на значок *Эллипс* |ch7-lo-screen-019| на панели инструментов *Рисование*. Круг – это эллипс, у которого все оси равны по длине. Чтобы нарисовать круг, нажмите на значок *Эллипс* и, удерживая нажатой клавишу ``Shift``, нажмите клавишу мыши в нужном месте листа и тяните курсор.
...
.. |ch7-lo-screen-019| image:: _static/chapter7/ch7-lo-screen-019.png
        :scale: 70% 
...
Чтобы нарисовать кривую или многоугольник нажмите на значок *Кривая* |ch7-lo-screen-020| на панели инструментов *Рисование*. Нажмите на треугольник справа от значка, чтобы открыть палитру  доступных инструментов (рисунок ниже). Значок принимает вид последнего использованного инструмента, что упрощает его повторное использование.

.. |ch7-lo-screen-020| image:: _static/chapter7/ch7-lo-screen-020.png
        :scale: 70% 
...
.. figure:: _static/chapter7/ch7-lo-screen-021.png
       :scale: 60 %
       :align: center
...
Чтобы включить инструмент добавления горизонтального текста, нажмите на значок *Текст* |ch7-lo-screen-022| или для вертикального текста – значок *Вертикальный текст* |ch7-lo-screen-022a|. Если значок *Вертикальный текст* не виден, активируйте опцию *Азиатские* в меню :menuselection:`Сервис --> Параметры --> Настройки языка --> Языки`. После нажатия на значок *Текст* станет доступна панель инструментов *Форматирование текста*. На этой панели инструментов можно выбрать вид шрифта, его размер и другие свойства шрифтов перед началом ввода текста.

.. |ch7-lo-screen-022| image:: _static/chapter7/ch7-lo-screen-022.png
        :scale: 80% 

.. |ch7-lo-screen-022a| image:: _static/chapter7/ch7-lo-screen-022a.png
        :scale: 80% 

.. note:: Значок *Вертикальный текст* |ch7-lo-screen-022a| доступен только на панели инструментов *Рисование*.
...
.. figure:: _static/chapter7/ch7-lo-screen-023.png
       :scale: 60 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-026.png
       :scale: 60 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-027.png
       :scale: 80 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-028.png
       :scale: 60 %
       :align: center
...
Щелкните на треугольнике справа от значка *Основные фигуры* |ch7-lo-screen-029|, чтобы открыть палитру инструментов *Основные фигуры*. Эта палитра включает в себя инструмент рисования прямоугольника, идентичный тому, который уже отображается на панели инструментов *Рисование*.

.. |ch7-lo-screen-029| image:: _static/chapter7/ch7-lo-screen-029.png
        :scale: 80%

.. _ch7-lo-screen-030:

.. figure:: _static/chapter7/ch7-lo-screen-030.png
       :scale: 60 %
       :align: center
...
Щелкните на треугольнике справа от значка *Фигуры-символы* |ch7-lo-screen-031|, чтобы открыть одноименную палитру инструментов.

.. |ch7-lo-screen-031| image:: _static/chapter7/ch7-lo-screen-031.png
        :scale: 80%

.. _ch7-lo-screen-032:

.. figure:: _static/chapter7/ch7-lo-screen-032.png
       :scale: 60 %
       :align: center
...
Щелкните на треугольнике справа от значка *Блочные стрелки* |ch7-lo-screen-033|, чтобы открыть одноименную палитру инструментов.

.. |ch7-lo-screen-033| image:: _static/chapter7/ch7-lo-screen-033.png
        :scale: 80%

.. _ch7-lo-screen-034:

.. figure:: _static/chapter7/ch7-lo-screen-034.png
       :scale: 60 %
       :align: center
...
Щелкните на треугольнике справа от значка *Блок-схемы* |ch7-lo-screen-035|, чтобы открыть одноименную палитру инструментов. Создание блок-схем, организационных диаграмм, и аналогичные инструменты планирования описаны в *Руководстве по Draw. Глава 8. Соединения, блок-схемы и организационные диаграммы*.

.. |ch7-lo-screen-035| image:: _static/chapter7/ch7-lo-screen-035.png
        :scale: 80%

.. _ch7-lo-screen-036:

.. figure:: _static/chapter7/ch7-lo-screen-036.png
       :scale: 60 %
       :align: center
...
Щелкните на треугольнике справа от значка *Выноски* |ch7-lo-screen-037|, чтобы открыть одноименную палитру инструментов.

.. |ch7-lo-screen-037| image:: _static/chapter7/ch7-lo-screen-037.png
        :scale: 80%

.. _ch7-lo-screen-038:

.. figure:: _static/chapter7/ch7-lo-screen-038.png
       :scale: 60 %
       :align: center
...
Щелкните на треугольнике справа от значка *Звезды и свитки* |ch7-lo-screen-039|, чтобы открыть одноименную палитру инструментов.

.. |ch7-lo-screen-039| image:: _static/chapter7/ch7-lo-screen-039.png
        :scale: 80%

.. _ch7-lo-screen-040:

.. figure:: _static/chapter7/ch7-lo-screen-040.png
       :scale: 60 %
       :align: center
...
Для множественного выделения объектов значок *Выделение* |ch7-lo-screen-041| на панели инструментов *Рисование* должен быть нажатым.

.. |ch7-lo-screen-041| image:: _static/chapter7/ch7-lo-screen-041.png
        :scale: 80%
...
В сложных рисунках несколько объектов могут быть наложены друг на друга. Чтобы изменить порядок размещения объектов (передний/задний план), выделите объект, выберите пункт главного меню :menuselection:`Изменить --> Расположить` и выберите вариант *Переместить вперед* или *Переместить назад*. Также можно щелкнуть правой кнопкой мыши на объекте и выбрать пункт *Расположить* из контекстного меню, а затем вариант *Переместить вперед* или *Переместить назад*.
 
Настройки расположения также доступны при щелчке на треугольнике справа от значка *Расположить* |ch7-lo-screen-042| на панели инструментов *Линия и заливка*. Откроется панель инструментов *Положение*, предоставляющая доступ к различным варианам расположения объектов (рисунок ниже).

.. |ch7-lo-screen-042| image:: _static/chapter7/ch7-lo-screen-042.png
        :scale: 80%

.. _ch7-lo-screen-043:

.. figure:: _static/chapter7/ch7-lo-screen-043.png
       :scale: 60 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-045.png
       :scale: 60 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-046.png
       :scale: 60 %
       :align: center
...
.. note:: Если при изменении размера объекта нажать клавишу ``Shift``, то изменение размера будет осуществляться симметрично по двум осям, так что соотношение длин сторон объекта остается таким же. Это поведение клавиши ``Shift`` работает для всех точек.
    ...
    Это поведение по умолчанию клавиши ``Shift``. Однако, если опция *При создании и перемещении объектов* в меню :menuselection:`Сервис --> Параметры --> LibreOffice Draw --> Сетка` активна, то нажатие на клавишу ``Shift`` будет иметь обратное действие: соотношение сторон будет сохранено, если *не нажата* клавиша ``Shift``.
...
* Нажмите на треугольник справа от значка *Эффекты*  на панели инструментов *Линия и заливка* и в палитре инструментов нажмите на значок *Повернуть* |ch7-lo-screen-047|.
* Выберите пункт меню :menuselection:`Вид --> Панели инструментов --> Операции` и нажмите значок *Повернуть* |ch7-lo-screen-047|.

.. |ch7-lo-screen-047| image:: _static/chapter7/ch7-lo-screen-047.png
        :scale: 80%
...
.. figure:: _static/chapter7/ch7-lo-screen-048.png
       :scale: 60 %
       :align: center
...
.. note:: Если нажать клавишу ``Shift`` при вращении объекта, вращение будет производится дискретно с шагом в 15°.
    ...
    Это поведение по умолчанию клавиши ``Shift``. Однако, если опция *При создании и перемещении объектов* в меню :menuselection:`Сервис --> Параметры --> LibreOffice Draw --> Сетка` активна, то нажатие на клавишу ``Shift`` будет иметь обратное действие: вращение всегда будет происходить с градацией по  15°, пока клавиша ``Shift`` **не нажата**.
...
.. figure:: _static/chapter7/ch7-lo-screen-049.png
       :scale: 60 %
       :align: center
       :alt: Наклон объекта
...
.. note:: Если нажать клавишу ``Shift`` во время наклона объекта, то наклон будет осуществляться дискретно на величину 15°. Это поведение клавиши ``Shift`` по умолчанию. Однако, если опция *При создании и перемещении объектов* в меню :menuselection:`Сервис --> Параметры --> LibreOffice Draw --> Сетка` активна, то нажатие на клавишу ``Shift`` будет иметь обратное действие: наклон всегда будет происходить дискретно по  15°, пока клавиша ``Shift`` **не нажата**.
...
По умолчанию панель инструментов *Линия и заливка* расположена в верхней части окна Draw. Однако, если панель *Линия и заливка* не отображается, необходимо выбрать пункт меню :menuselection:`Вид --> Панели инструментов --> Линия и заливка`, чтобы отобразить панель (рисунок ниже). Используя эту панель, можно редактировать наиболее распространённые атрибуты объекта. 

.. _ch7-lo-screen-050:

.. figure:: _static/chapter7/ch7-lo-screen-050.png
       :scale: 70 %
       :align: center
       :alt: Панель инструментов Линия и заливка
...
Если в Draw выделить текст, то панель *Линия и заливка* автоматически заменится на панель *Форматирование текста* (рисунок ниже). Также можно в любой момент открыть эту панель, выбрав пункт меню :menuselection:`Вид --> Панели инструментов --> Форматирование текста`. Инструменты на этой панели будут неактивными, пока не будет выделен текст.

.. _ch7-lo-screen-051:

.. figure:: _static/chapter7/ch7-lo-screen-051.png
       :scale: 60 %
       :align: center
       :alt: Панель инструментов Форматирование текста
...
.. figure:: _static/chapter7/ch7-lo-screen-052.png
       :scale: 50 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-053.png
       :scale: 50 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-054.png
       :scale: 60 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-055.png
       :scale: 60 %
       :align: center
...
.. figure:: _static/chapter7/ch7-lo-screen-056.png
       :scale: 60 %
       :align: center
...
Привязка к сетке позволяет позиционировать объект относительно точек сетки. Выберите пункт меню :menuselection:`Вид --> Сетка --> Привязка к сетке` или щелкните по значку *Привязка к сетке* на панели инструментов *Параметры*, чтобы включить или отключить функцию привязки к сетке. Если панель инструментов *Параметры* не отображается, выберите пункт  меню :menuselection:`Вид --> Панели инструментов --> Параметры`.

.. _ch7-lo-screen-057:

.. figure:: _static/chapter7/ch7-lo-screen-057.png
       :scale: 60 %
       :align: center
...
Чтобы отображать (или отключить отображение) сетку на листе Draw, выберите пункт меню  :menuselection:`Вид --> Сетка --> Показать сетку` или нажмите на значок *Показать сетку* на панели инструментов *Параметры*.

Конфигурация сетки
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Разрешение, привязка и положение точек сетки и другие параметры могут быть настроены в  диалоговом окне, доступном из меню :menuselection:`Сервис --> Параметры --> LibreOffice Draw --> Сетка`.

.. _ch7-lo-screen-058:

.. figure:: _static/chapter7/ch7-lo-screen-058.png
       :scale: 50 %
       :align: center
...
* Вертикальный и горизонтальный промежуток между точками в сетке. Также можно изменить используемые единицы измерения в общих параметрах Draw, перейдя в меню :menuselection:`Сервис --> Параметры --> LibreOffice Draw --> Общие`.
...
Цвет сетки по умолчанию светло-серый. Чтобы изменить цвет сетки, откройте меню  :menuselection:`Сервис --> Параметры --> LibreOffice --> Внешний вид`, в списке справа найдите пункт *Сетка* и задайте ему новый цвет.

Вспомогательные линии
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

В Draw есть вспомогательные линии, которые легко позволяют позиционировать объект с помощью линеек в верхней и левой части рабочей области. Для включения или выключения вспомогательных линий, откройте диалог из меню :menuselection:`Сервис --> Параметры --> LibreOffice Draw --> Вид` и выберите опцию *Направляющие при перемещении*.
...
Для доступа к инструментам специальных эффектов выберите пункт меню :menuselection:`Вид --> Панели инструментов --> Операции`. Команды *Повернуть* и *Отразить* можно также найти в меню *Изменить* или, после нажатия правой кнопкой мыши на объекте, в контекстном меню.

.. _ch7-lo-screen-059:

.. figure:: _static/chapter7/ch7-lo-screen-059.png
       :scale: 60 %
       :align: center
...
2. Щелкните по объекту правой кнопкой мыши и выберите в контекстном меню пункт :menuselection:`Отражение --> По вертикали` (или *По горизонтали*), или выберите пункт меню :menuselection:`Изменить --> Отражение --> По вертикали` (или *По горизонтали*)и выбранный объект будет отражен.
...
.. figure:: _static/chapter7/ch7-lo-screen-060.png
       :scale: 50 %
       :align: center
...
1. Выделите объект или группу объектов и выберите пункт меню :menuselection:`Правка --> Дублировать` или используйте сочетание клавиш ``Shift+F3``, чтобы открыть одноименный диалог.
...
.. figure:: _static/chapter7/ch7-lo-screen-061.png
       :scale: 60 %
       :align: center
...
2. Выберите пункт меню :menuselection:`Правка --> Морфинг`.
...
.. figure:: _static/chapter7/ch7-lo-screen-062.png
       :scale: 60 %
       :align: center
       :alt: Диалог Морфинг
...
.. figure:: _static/chapter7/ch7-lo-screen-063.png
       :scale: 60 %
       :align: center
...
Можно редактировать отдельные объекты в группе без разгруппировки. Выберите группу и выберите пункт меню :menuselection:`Изменить --> Зайти в группу` или щелкните правой кнопкой мыши и выберите пункт *Зайти в группу* из контекстного меню, или используйте клавишу ``F3``, или дважды щелкните по группе.

После окончания изменения отдельного элемента группы выберите пункт меню :menuselection:`Изменить --> Выйти из группы``, или щелкните правой кнопкой мыши и выберите пункт контекстного меню  *Выйти из группы*, или используйте сочетание клавиш ``Shift+F3``.

Разгруппировка
"""""""""""""""""""""""""""""""""

Чтобы разгруппировать группу объектов, выделите группу, затем выберите пункт меню :menuselection:`Изменить --> Разгруппировать` или щелкните правой кнопкой мыши и выберите пункт  *Разгруппировать* из контекстного меню, или используйте комбинацию клавиш ``Ctrl + Alt + Shift + G``.
...
Выберите несколько объектов, а затем выберите пункт меню :menuselection:`Изменить --> Объединить`` или щелкните правой кнопкой мыши на объекте и выберите пункт *Объединить* из контекстного меню, или используйте сочетание клавиш ``Ctrl + Shift + K``.
...
* Напрямую со сканера (меню :menuselection:`Вставка --> Изображение --> Сканировать`)
* Изображение, созданное в другой программе, включая фотографии с цифровой камеры (меню :menuselection:`Вставка --> Изображение --> Из файла`)
...
.. figure:: _static/chapter7/ch7-lo-screen-064.png
       :scale: 60 %
       :align: center
...
1. Выберите пункт меню :menuselection:`Вставка --> Примечание`. Небольшое поле, содержащее  инициалы текущего пользователя, появится в верхнем левом углу рисунка с большим текстовым полем рядом с ним. Draw автоматически добавит имя пользователя и дату в нижней части текстового поля.
...
5. Используйте меню :menuselection:`Сервис --> Параметры --> LibreOffice --> Сведения о пользователе`,  чтобы ввести имя, которое будет отображаться в примечании в поле «Автор».
...
.. note:: Смотрите также статьи:
    ...
    * `Подложка или как сделать надпись Образец (Водяной знак)  <http://librerussia.blogspot.ru/2014/11/libreoffice_2.html>`_
    * `Быстрое выравнивание объектов друг относительно друга <http://librerussia.blogspot.ru/2014/10/libreoffice_3.html>`_
    * `Часто задаваемые вопросы - LibreOffice Draw <https://wiki.documentfoundation.org/Faq/Draw/ru>`_
