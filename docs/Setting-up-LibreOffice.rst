...
Опция *Задание печати в формате PDF* не доступна на Windows. Выберите этот параметр, чтобы изменить внутренний формат вывода на печеть из языка описания Postscript на вывод из PDF. Этот формат имеет ряд преимуществ по сравнению с PostScript [#]_.  Отмена выбора этой опции возвращает к Postscript.
