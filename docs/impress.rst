...
1) Включите режим редактирования мастер-слайда, выбрав пункт меню :menuselection:`Вид --> Фон --> Мастер слайдов`, появится панель инструментов *Режим фона* (рисунок ниже). Если панель инструментов *Режим фона* не отобразится, то активируйте её в меню :menuselection:`Вид --> Панели инструментовё.
